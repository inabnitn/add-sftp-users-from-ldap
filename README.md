...
The config file 'ldap_pw' must NOT contain a newline, because the 'ldapsearch' command treats all characters (including the newline) as part of the password. To get around this, remove the newline using whatever method you prefer, for example: truncate --size=-1 ldap_pw_file
