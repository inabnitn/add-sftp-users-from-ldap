...
The LDAP password file specified below must not contain a newline, because the 'ldapsearch' command will include the newline as part of the password. To get around this, remove the newline using whatever method you prefer, for example: truncate --size=-1 ldap_pw_file
